defmodule TimeManagerAppWeb.WorkingTimeControllerTest do
  ...
  @create_attrs %{
    end: ~U[2024-10-13 14:49:00Z],
    start: ~U[2024-10-13 14:49:00Z]
  }
  @update_attrs %{
    end: ~U[2024-10-14 14:49:00Z],
    start: ~U[2024-10-14 14:49:00Z]
  }
  ...
  describe "create working_time" do
    test "renders working_time when data is valid", %{conn: conn} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2024-10-13T14:49:00Z",
               "start" => "2024-10-13T14:49:00Z"
  ...
  describe "update working_time" do
    ...
    test "renders working_time when data is valid", %{conn: conn, working_time: %WorkingTime{id: id} = working_time} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2024-10-14T14:49:00Z",
               "start" => "2024-10-14T14:49:00Z"
             } = json_response(conn, 200)["data"]
    end
