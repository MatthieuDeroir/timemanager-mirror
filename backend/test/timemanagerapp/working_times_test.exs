defmodule TimeManagerApp.WorkingTimesTest do
  ...
  describe "working_times" do
    ...
    import TimeManagerApp.WorkingTimesFixtures
    ...
    test "create_working_time/1 with valid data creates a working_time" do
      valid_attrs = %{end: ~U[2024-10-13 14:49:00Z], start: ~U[2024-10-13 14:49:00Z]}

      assert {:ok, %WorkingTime{} = working_time} = WorkingTimes.create_working_time(valid_attrs)
      assert working_time.end == ~U[2024-10-13 14:49:00Z]
      assert working_time.start == ~U[2024-10-13 14:49:00Z]
    end
    ...
    test "update_working_time/2 with valid data updates the working_time" do
      working_time = working_time_fixture()
      update_attrs = %{end: ~U[2024-10-14 14:49:00Z], start: ~U[2024-10-14 14:49:00Z]}

      assert {:ok, %WorkingTime{} = working_time} = WorkingTimes.update_working_time(working_time, update_attrs)
      assert working_time.end == ~U[2024-10-14 14:49:00Z]
      assert working_time.start == ~U[2024-10-14 14:49:00Z]
    end
